...
Namespace GridDemo
    ...
    Public Module DemoModuleWYSIWYGExportHelper
        ...
        Public Sub DoExport(ByVal view As DataViewBase, ByVal format As ExportFormat)
            Select Case format
        ...
        Private Sub Export(Of T As {ExportOptionsBase, New})(ByVal view As DataViewBase, ByVal getExportToStreamMethod As Func(Of PrintableControlLink, Action(Of Stream, T)))
    ...
    Public Module DemoModuleExportHelper
        ...
        Public Sub ExportToXlsx(ByVal view As DataViewBase)
            Export(New Action(Of Stream, XlsxExportOptionsEx)(AddressOf view.ExportToXlsx))
        End Sub

        Public Sub ExportToXls(ByVal view As DataViewBase)
            Export(New Action(Of Stream, XlsExportOptionsEx)(AddressOf view.ExportToXls))
        End Sub

        Public Sub ExportToCsv(ByVal view As DataViewBase)
    ...
    Friend Module ExportHelper
        ...
        Private Function ShouldOpenExportedFile() As Boolean
            Return ThemedMessageBox.Show(PreviewLocalizer.GetString(PreviewStringId.Msg_OpenFileQuestionCaption), PreviewLocalizer.GetString(PreviewStringId.Msg_OpenFileQuestion), MessageBoxButton.YesNo, MessageBoxImage.Question) = MessageBoxResult.Yes
        End Function
    End Module
