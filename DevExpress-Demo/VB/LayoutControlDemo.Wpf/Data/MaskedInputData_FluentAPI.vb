...
#Region "Numeric masks"
            ...
            PropertyMetadataBuilderExtensions.NumericMask(builder.Property(Function(x) x.EuroCurrencyProperty).DisplayName("Currency (EURO)"), PredefinedMasks.Numeric.Currency).MaskCulture(New CultureInfo("fr-FR"))
