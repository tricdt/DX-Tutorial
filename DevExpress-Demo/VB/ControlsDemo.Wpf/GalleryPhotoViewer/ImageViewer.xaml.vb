...
#Region "Dependency Properties"
        Public Shared ReadOnly ScaleProperty As DependencyProperty = DependencyProperty.Register("Scale", GetType(Double), GetType(ImageViewer), New PropertyMetadata(1R, New PropertyChangedCallback(AddressOf ControlsDemo.GalleryDemo.ImageViewer.OnScalePropertyChanged)))
        ...
        Public Shared ReadOnly ImageSourceProperty As DependencyProperty = DependencyProperty.Register("ImageSource", GetType(BitmapSource), GetType(ImageViewer), New PropertyMetadata(CType(Nothing, PropertyChangedCallback)))
...
#End Region  ' Dependency Properties
        ...
        Public Property ImageSource As BitmapSource
            Get
                Return CType(GetValue(ImageSourceProperty), BitmapSource)
            End Get
...
#Region "Dependency Properties"
        Public Shared ReadOnly RotationProperty As DependencyProperty = DependencyProperty.Register("Rotation", GetType(Rotation), GetType(ImagePresenter), New PropertyMetadata(Rotation.Rotate90, New PropertyChangedCallback(AddressOf ControlsDemo.GalleryDemo.ImagePresenter.OnRotationPropertyChanged)))

        Public Shared ReadOnly ContentProperty As DependencyProperty = DependencyProperty.Register("Content", GetType(UIElement), GetType(ImagePresenter), New PropertyMetadata(Nothing, New PropertyChangedCallback(AddressOf ControlsDemo.GalleryDemo.ImagePresenter.OnContentPropertyChanged)))

        Public Shared ReadOnly ScaleProperty As DependencyProperty = DependencyProperty.Register("Scale", GetType(Double), GetType(ImagePresenter), New PropertyMetadata(1R, New PropertyChangedCallback(AddressOf ControlsDemo.GalleryDemo.ImagePresenter.OnScalePropertyChanged)))
