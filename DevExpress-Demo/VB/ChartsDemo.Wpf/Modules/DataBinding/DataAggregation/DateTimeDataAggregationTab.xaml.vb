...
Namespace ChartsDemo
    ...
    Public Partial Class DateTimeDataAggregationTab
        Inherits TabItemModule

        Public Shared ReadOnly TitleProperty As DependencyProperty = DependencyProperty.Register("Title", GetType(String), GetType(DateTimeDataAggregationTab), Nothing)
        ...
        Private Sub chart_AxisScaleChanged(ByVal sender As Object, ByVal e As AxisScaleChangedEventArgs)
            ...
            Dim numericArgs As DateTimeScaleChangedEventArgs = TryCast(e, DateTimeScaleChangedEventArgs)
