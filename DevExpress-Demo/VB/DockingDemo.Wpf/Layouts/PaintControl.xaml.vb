...
#Region "static        "
        ...
        Shared Sub New()
            DockingDemo.PaintControl.ShowAutomaticButtonProperty = System.Windows.DependencyProperty.Register("ShowAutomaticButton", GetType(Boolean), GetType(DockingDemo.PaintControl), New System.Windows.PropertyMetadata(True))
            DockingDemo.PaintControl.ShowNoColorButtonProperty = System.Windows.DependencyProperty.Register("ShowNoColorButton", GetType(Boolean), GetType(DockingDemo.PaintControl), New System.Windows.PropertyMetadata(False))
            DockingDemo.PaintControl.ShowMoreColorsButtonProperty = System.Windows.DependencyProperty.Register("ShowMoreColorsButton", GetType(Boolean), GetType(DockingDemo.PaintControl), New System.Windows.PropertyMetadata(False))
            DockingDemo.PaintControl.ChipSizeProperty = System.Windows.DependencyProperty.Register("ChipSize", GetType(DevExpress.Xpf.Editors.ChipSize), GetType(DockingDemo.PaintControl), New System.Windows.PropertyMetadata(DevExpress.Xpf.Editors.ChipSize.[Default]))
            DockingDemo.PaintControl.BrushSizeProperty = System.Windows.DependencyProperty.Register("BrushSize", GetType(Double), GetType(DockingDemo.PaintControl), New System.Windows.PropertyMetadata(8R))
            DockingDemo.PaintControl.BrushOpacityProperty = System.Windows.DependencyProperty.Register("BrushOpacity", GetType(Double), GetType(DockingDemo.PaintControl), New System.Windows.PropertyMetadata(1R))
            DockingDemo.PaintControl.TextFontFamilyProperty = System.Windows.DependencyProperty.Register("TextFontFamily", GetType(System.Windows.Media.FontFamily), GetType(DockingDemo.PaintControl), New System.Windows.PropertyMetadata(CType(Nothing, System.Windows.PropertyChangedCallback)))
            DockingDemo.PaintControl.TextFontSizeProperty = System.Windows.DependencyProperty.Register("TextFontSize", GetType(Double), GetType(DockingDemo.PaintControl), New System.Windows.PropertyMetadata(12R))
            DockingDemo.PaintControl.TextFontColorProperty = System.Windows.DependencyProperty.Register("TextFontColor", GetType(System.Windows.Media.Color), GetType(DockingDemo.PaintControl), New System.Windows.PropertyMetadata(System.Windows.Media.Colors.Black))
            DockingDemo.PaintControl.BackgroundTextColorProperty = System.Windows.DependencyProperty.Register("BackgroundTextColor", GetType(System.Windows.Media.Color), GetType(DockingDemo.PaintControl), New System.Windows.PropertyMetadata(System.Windows.Media.Colors.Transparent))
            DockingDemo.PaintControl.BackgroundImageSourceProperty = System.Windows.DependencyProperty.Register("BackgroundImageSource", GetType(System.Windows.Media.ImageSource), GetType(DockingDemo.PaintControl), New System.Windows.PropertyMetadata(CType(Nothing, System.Windows.Media.Imaging.BitmapImage), New System.Windows.PropertyChangedCallback(AddressOf DockingDemo.PaintControl.OnBackgroundImagePropertyChanged)))
            DockingDemo.PaintControl.BrushColorProperty = System.Windows.DependencyProperty.Register("BrushColor", GetType(System.Windows.Media.Color), GetType(DockingDemo.PaintControl), New System.Windows.PropertyMetadata(System.Windows.Media.Colors.Red))
            DockingDemo.PaintControl.MaxBrushSizeProperty = System.Windows.DependencyProperty.Register("MaxBrushSize", GetType(Double), GetType(DockingDemo.PaintControl), New System.Windows.PropertyMetadata(24R))
            DockingDemo.PaintControl.MinBrushSizeProperty = System.Windows.DependencyProperty.Register("MinBrushSize", GetType(Double), GetType(DockingDemo.PaintControl), New System.Windows.PropertyMetadata(1R))
            DockingDemo.PaintControl.MousePositionProperty = System.Windows.DependencyProperty.Register("MousePosition", GetType(System.Windows.Point), GetType(DockingDemo.PaintControl), New System.Windows.PropertyMetadata(New System.Windows.Point(-1, -1)))
            DockingDemo.PaintControl.IsBrushToolSelectedProperty = System.Windows.DependencyProperty.Register("IsBrushToolSelected", GetType(Boolean), GetType(DockingDemo.PaintControl), New System.Windows.PropertyMetadata(True, New System.Windows.PropertyChangedCallback(AddressOf DockingDemo.PaintControl.OnIsBrushToolSelectedPropertyChanged)))
            DockingDemo.PaintControl.IsTextToolSelectedProperty = System.Windows.DependencyProperty.Register("IsTextToolSelected", GetType(Boolean), GetType(DockingDemo.PaintControl), New System.Windows.PropertyMetadata(False, New System.Windows.PropertyChangedCallback(AddressOf DockingDemo.PaintControl.OnIsTextToolSelectedPropertyChanged)))
            DockingDemo.PaintControl.IsTextEditingProperty = System.Windows.DependencyProperty.Register("IsTextEditing", GetType(Boolean), GetType(DockingDemo.PaintControl), New System.Windows.PropertyMetadata(False))
        End Sub
        ...
        Public Shared Sub OnBackgroundImagePropertyChanged(ByVal d As System.Windows.DependencyObject, ByVal e As System.Windows.DependencyPropertyChangedEventArgs)
            CType(d, DockingDemo.PaintControl).OnBackgroundImageChanged(e)
        End Sub
        ...
        Private Shared Sub OnIsBrushToolSelectedPropertyChanged(ByVal d As System.Windows.DependencyObject, ByVal e As System.Windows.DependencyPropertyChangedEventArgs)
            CType(d, DockingDemo.PaintControl).OnIsBrushToolSelectedChanged()
        End Sub
        ...
        Private Shared Sub OnIsTextToolSelectedPropertyChanged(ByVal d As System.Windows.DependencyObject, ByVal e As System.Windows.DependencyPropertyChangedEventArgs)
            CType(d, DockingDemo.PaintControl).OnIsTextToolSelectedChanged()
        End Sub
...
#Region "props"
        Public Property MousePosition As Point
            Get
                Return CType(Me.GetValue(DockingDemo.PaintControl.MousePositionProperty), System.Windows.Point)
            End Get

            Set(ByVal value As Point)
                Me.SetValue(DockingDemo.PaintControl.MousePositionProperty, value)
            End Set
        End Property

        Public Property ShowAutomaticButton As Boolean
            Get
                Return CBool(Me.GetValue(DockingDemo.PaintControl.ShowAutomaticButtonProperty))
            End Get

            Set(ByVal value As Boolean)
                Me.SetValue(DockingDemo.PaintControl.ShowAutomaticButtonProperty, value)
            End Set
        End Property

        Public Property ShowNoColorButton As Boolean
            Get
                Return CBool(Me.GetValue(DockingDemo.PaintControl.ShowNoColorButtonProperty))
            End Get

            Set(ByVal value As Boolean)
                Me.SetValue(DockingDemo.PaintControl.ShowNoColorButtonProperty, value)
            End Set
        End Property

        Public Property ShowMoreColorsButton As Boolean
            Get
                Return CBool(Me.GetValue(DockingDemo.PaintControl.ShowMoreColorsButtonProperty))
            End Get

            Set(ByVal value As Boolean)
                Me.SetValue(DockingDemo.PaintControl.ShowMoreColorsButtonProperty, value)
            End Set
        End Property

        Public Property BrushSize As Double
            Get
                Return CDbl(Me.GetValue(DockingDemo.PaintControl.BrushSizeProperty))
            End Get

            Set(ByVal value As Double)
                Me.SetValue(DockingDemo.PaintControl.BrushSizeProperty, value)
            End Set
        End Property

        Public Property ChipSize As ChipSize
            Get
                Return CType(Me.GetValue(DockingDemo.PaintControl.ChipSizeProperty), DevExpress.Xpf.Editors.ChipSize)
            End Get

            Set(ByVal value As ChipSize)
                Me.SetValue(DockingDemo.PaintControl.ChipSizeProperty, value)
            End Set
        End Property

        Public Property MinBrushSize As Double
            Get
                Return CDbl(Me.GetValue(DockingDemo.PaintControl.MinBrushSizeProperty))
            End Get

            Set(ByVal value As Double)
                Me.SetValue(DockingDemo.PaintControl.MinBrushSizeProperty, value)
            End Set
        End Property

        Public Property MaxBrushSize As Double
            Get
                Return CDbl(Me.GetValue(DockingDemo.PaintControl.MaxBrushSizeProperty))
            End Get

            Set(ByVal value As Double)
                Me.SetValue(DockingDemo.PaintControl.MaxBrushSizeProperty, value)
            End Set
        End Property

        Public Property BrushColor As Color
            Get
                Return CType(Me.GetValue(DockingDemo.PaintControl.BrushColorProperty), System.Windows.Media.Color)
            End Get

            Set(ByVal value As Color)
                Me.SetValue(DockingDemo.PaintControl.BrushColorProperty, value)
            End Set
        End Property

        Public Property TextFontColor As Color
            Get
                Return CType(Me.GetValue(DockingDemo.PaintControl.TextFontColorProperty), System.Windows.Media.Color)
            End Get

            Set(ByVal value As Color)
                Me.SetValue(DockingDemo.PaintControl.TextFontColorProperty, value)
            End Set
        End Property

        Public Property BackgroundTextColor As Color
            Get
                Return CType(Me.GetValue(DockingDemo.PaintControl.BackgroundTextColorProperty), System.Windows.Media.Color)
            End Get

            Set(ByVal value As Color)
                Me.SetValue(DockingDemo.PaintControl.BackgroundTextColorProperty, value)
            End Set
        End Property

        Public Property BackgroundImageSource As ImageSource
            Get
                Return CType(Me.GetValue(DockingDemo.PaintControl.BackgroundImageSourceProperty), System.Windows.Media.ImageSource)
            End Get

            Set(ByVal value As ImageSource)
                Me.SetValue(DockingDemo.PaintControl.BackgroundImageSourceProperty, value)
            End Set
        End Property

        Public Property BrushOpacity As Double
            Get
                Return CDbl(Me.GetValue(DockingDemo.PaintControl.BrushOpacityProperty))
            End Get

            Set(ByVal value As Double)
                Me.SetValue(DockingDemo.PaintControl.BrushOpacityProperty, value)
            End Set
        End Property

        Public Property TextFontSize As Double
            Get
                Return CDbl(Me.GetValue(DockingDemo.PaintControl.TextFontSizeProperty))
            End Get

            Set(ByVal value As Double)
                Me.SetValue(DockingDemo.PaintControl.TextFontSizeProperty, value)
            End Set
        End Property

        Public Property TextFontFamily As FontFamily
            Get
                Return CType(Me.GetValue(DockingDemo.PaintControl.TextFontFamilyProperty), System.Windows.Media.FontFamily)
            End Get

            Set(ByVal value As FontFamily)
                Me.SetValue(DockingDemo.PaintControl.TextFontFamilyProperty, value)
            End Set
        End Property

        Public Property IsBrushToolSelected As Boolean
            Get
                Return CBool(Me.GetValue(DockingDemo.PaintControl.IsBrushToolSelectedProperty))
            End Get

            Set(ByVal value As Boolean)
                Me.SetValue(DockingDemo.PaintControl.IsBrushToolSelectedProperty, value)
            End Set
        End Property

        Public Property IsTextToolSelected As Boolean
            Get
                Return CBool(Me.GetValue(DockingDemo.PaintControl.IsTextToolSelectedProperty))
            End Get

            Set(ByVal value As Boolean)
                Me.SetValue(DockingDemo.PaintControl.IsTextToolSelectedProperty, value)
            End Set
        End Property

        Public Property IsTextEditing As Boolean
            Get
                Return CBool(Me.GetValue(DockingDemo.PaintControl.IsTextEditingProperty))
            End Get

            Set(ByVal value As Boolean)
                Me.SetValue(DockingDemo.PaintControl.IsTextEditingProperty, value)
            End Set
        End Property
...
#Region "commands implementation"
        Protected Sub SaveCommandExecute()
            ...
            Dim dlg As Microsoft.Win32.SaveFileDialog = New Microsoft.Win32.SaveFileDialog() With {.Filter = DockingDemo.PaintControl.filterString, .Title = "Save file..."}
        ...
        Protected Sub OpenCommandExecute()
            Me.CompleteTextEditing(True)
            Dim dialog As Microsoft.Win32.OpenFileDialog = New Microsoft.Win32.OpenFileDialog() With {.Filter = DockingDemo.PaintControl.filterString, .Title = "Open file..."}
        ...
        Protected Sub ClearCommandExecute()
            ...
            Me.SetCurrentValue(DockingDemo.PaintControl.BackgroundImageSourceProperty, Nothing)
        End Sub
