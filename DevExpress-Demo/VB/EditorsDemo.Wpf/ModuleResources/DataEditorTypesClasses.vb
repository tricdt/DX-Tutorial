...
#Region "Field Descriptions"
        ...
        Protected Overridable Function CreateFieldDescriptions() As List(Of FieldDescription)
            Return New List(Of FieldDescription)() From {New FieldDescription("ProductName", "Name", "TextEdit", "TextEdit", GetType(String), 1, -1), New FieldDescription("ProductID", "ID", "TextEdit (with numeric mask)", "NumericTextEdit", GetType(Integer), 0, 1), New FieldDescription("EAN13", "Code", "TextEdit (with RegEx mask)", "RegExTextEdit", GetType(String), 9, 1), New FieldDescription("ProductName", "Name", "AutoSuggestEdit", "AutoSuggestEdit", GetType(String), 111, 13), New FieldDescription(String.Empty, "Password", "PasswordBoxEdit", "PasswordBoxEdit", GetType(String), 14, 1), New FieldDescription(String.Empty, "Countries", "ButtonEdit", "ButtonEdit", GetType(String), 13, -1), New FieldDescription("CategoryID", "Category", "ComboBoxEdit", "ComboBoxEdit", GetType(Integer), 2, 13), New FieldDescription(String.Empty, "Country", "ComboBoxEdit (with AutoComplete)", "AutoCompleteComboBoxEdit", GetType(String), 3, 2), New FieldDescription("CategoryID", "Categories", "ComboBoxEdit (Token Mode)", "TokenComboBoxEdit", GetType(String), 26, 2), New FieldDescription("CategoryID", "Category", "SearchLookUpEdit", "SearchLookUpEdit", GetType(Integer), 20, 2), New FieldDescription("CategoryID", "Category", "LookUpEdit", "LookUpEdit", GetType(Integer), 21, 2), New FieldDescription(String.Empty, "Notes", "MemoEdit", "MemoEdit", GetType(String), 10, 13), New FieldDescription(String.Empty, "Date", "DateEdit", "DateEdit", GetType(Date), 11, 13), New FieldDescription(String.Empty, "Font", "FontEdit", "FontEdit", GetType(FontFamily), 19, 13), New FieldDescription("UnitPrice", "Unit Price", "PopupCalcEdit", "PopupCalcEdit", GetType(Double), 15, 13), New FieldDescription(String.Empty, "Color", "PopupColorEdit", "PopupColorEdit", GetType(Color), 16, 13), New FieldDescription(String.Empty, "Orders", "SparklineEdit", "SparklineEdit", GetType(List(Of Integer)), 23, 13), New FieldDescription(String.Empty, "Picture", "PopupImageEdit", "PopupImageEdit", GetType(ImageSource), 17, 13), New FieldDescription("UnitsInStock", "Units In Stock", "TrackBarEdit", "TrackBarEdit", GetType(Double), 5, -1), New FieldDescription("ReorderLevel", "Reorder Level", "ZoomTrackBarEdit", "ZoomTrackBarEdit", GetType(Double), 6, 5), New FieldDescription(String.Empty, "Range", "RangeTrackBarEdit", "RangeTrackBarEdit", GetType(TrackBarEditRange), 7, 5), New FieldDescription(String.Empty, "Units On Order", "ProgressBarEdit", "ProgressBarEdit", GetType(Double), 18, 5), New FieldDescription("Discontinued", "Discontinued", "CheckEdit", "CheckEdit", GetType(Boolean), 8, -1), New FieldDescription(String.Empty, "Discontinued", "ToggleSwitchEdit", "ToggleSwitchEdit", GetType(Boolean), 28, -1), New FieldDescription(String.Empty, "Discount", "SpinEdit", "SpinEdit", GetType(Decimal), 4, -1), New FieldDescription(String.Empty, "Pallete Size", "ListBoxEdit", "ListBoxEdit", GetType(String), 12, -1), New FieldDescription(String.Empty, "ID", "BarCodeEdit", "BarCodeEdit", GetType(String), 25, -1), New FieldDescription("Rating", "Rating", "RatingEdit", "RatingEdit", GetType(Double), 27, -1), New FieldDescription("HyperLink", "Hyper Link", "HyperlinkEdit", "HyperlinkEdit", GetType(String), 29, -1)}
        End Function
