...
Namespace EditorsDemo
    ...
    Public Module OutlookDataGenerator
        ...
        Public Function GetSize(ByVal largeData As Boolean?) As Integer?
        ...
        Public Function CreateNewObject() As OutlookData
        ...
        Public Function CreateOutlookArrayList(ByVal rowCount As Integer) As Collections.ArrayList
            Dim dataList As Collections.ArrayList = New Collections.ArrayList(rowCount)
            For i As Integer = 0 To rowCount - 1
