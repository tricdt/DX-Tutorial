...
#Region "CommonWinApi"
        ...
        Public Const FILE_ATTRIBUTE_NORMAL As Integer = &H00000080
...
#End Region
        ...
        Public Function GetSmallIcon(ByVal name As String) As ImageSource
            Dim shfi As SHFILEINFO = New SHFILEINFO()
            Dim flags As SHGFI = SHGFI.Icon Or SHGFI.SmallIcon
            Dim result As ImageSource = Nothing
            Try
                Call SHGetFileInfo(name, FILE_ATTRIBUTE_NORMAL, shfi, CUInt(Marshal.SizeOf(shfi)), flags)
                If shfi.hIcon = IntPtr.Zero Then Return Nothing
