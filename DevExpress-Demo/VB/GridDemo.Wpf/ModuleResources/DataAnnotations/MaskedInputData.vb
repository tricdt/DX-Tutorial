...
#Region "Numeric masks"
        ...
        <Display(Name:="Currency", GroupName:=NumericStandardGroup)>
...
#End Region
        Const NumericStandardGroup As String = "Numeric masks/Standard"

        Const NumericCustomGroup As String = "Numeric masks/Custom"

        Const DateTimeStandardGroup As String = "DateTime masks/Standard"

        Const DateTimeCustomGroup As String = "DateTime masks/Custom"

        Const RegExGroup As String = "RegEx masks"
