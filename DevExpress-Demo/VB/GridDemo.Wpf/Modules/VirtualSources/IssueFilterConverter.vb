...
Namespace GridDemo
    ...
    Public Class IssueFilterConverter
        ...
        Private Function Convert(ByVal filter As Object, ByVal targetType As Type, ByVal parameter As Object, ByVal culture As Globalization.CultureInfo) As Object Implements IValueConverter.Convert
