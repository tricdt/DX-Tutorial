...
namespace SchedulingDemo {
    public static class EmployeesDataHelper {
        public static readonly List<Employee> Employees;
        static EmployeesDataHelper() {
    ...
    public static class TeamData {
        static TeamData() {
            ...
            Employees = EmployeesDataHelper.Employees;
        ...
        static TeamAppointment CreateBirthdayAppt(Employee employee) {
            ...
            appt.RecurrenceInfo = RecurrenceBuilder.Yearly(date).ByMonthDay(date.Month, date.Day).Build().ToXml();
            return appt;
        }
        ...
        static TeamAppointment CreateMeetingRecurrenceAppt(string subject, DateTime start) {
            ...
            appt.RecurrenceInfo = RecurrenceBuilder.Weekly(start).ByDay(WeekDays.Friday).Build().ToXml();
            return appt;
        }
        ...
        static IEnumerable<TeamAppointment> CreateCompanyBirthdayAppts(DateTime start) {
            ...
            appt.RecurrenceInfo = RecurrenceBuilder.Yearly(newStart).ByMonthDay(newStart.Month, newStart.Day).Build().ToXml();
        ...
        static IEnumerable<TeamAppointment> CreateTrainingAppts(DateTime start) {
            ...
            appt.RecurrenceInfo = RecurrenceBuilder.Weekly(newStart).ByDay(WeekDays.Monday | WeekDays.Wednesday | WeekDays.Friday).Build().ToXml();
            return new[] { appt };
        }
        ...
        static IEnumerable<TeamAppointment> CreatePayBillsAppts(DateTime start) {
            ...
            appt.RecurrenceInfo = RecurrenceBuilder.Monthly(newStart).ByDay(newStart.Day).Build().ToXml();
            return new[] { appt };
        }
