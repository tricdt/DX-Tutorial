...
namespace LayoutControlDemo {
    ...
    public static class Listings {
        readonly static IList<Listing> dataSource = CreateDataSource();
        public static IList<Listing> DataSource { get { return dataSource; } }

        static IList<Listing> CreateDataSource() {
            return new List<Listing> {
                new Listing (LayoutControlDemoModule.UriPrefix + "/Images/RealEstate/1.jpg") {
                ...
                new Listing(LayoutControlDemoModule.UriPrefix + "/Images/RealEstate/2.jpg") {
                ...
                new Listing(LayoutControlDemoModule.UriPrefix + "/Images/RealEstate/3.jpg") {
