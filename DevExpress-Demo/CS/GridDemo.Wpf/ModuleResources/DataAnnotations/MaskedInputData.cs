...
namespace GridDemo {
    public class MaskedInputData {
        ...
        const string NumericStandardGroup = "Numeric masks/Standard";
        const string NumericCustomGroup = "Numeric masks/Custom";
        const string DateTimeStandardGroup = "DateTime masks/Standard";
        const string DateTimeCustomGroup = "DateTime masks/Custom";
        const string RegExGroup = "RegEx masks";
