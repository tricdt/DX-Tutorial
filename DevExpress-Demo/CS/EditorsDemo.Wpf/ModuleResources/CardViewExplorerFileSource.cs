...
namespace GridDemo {
    public class CardViewExplorerFileSource {
        static readonly Func<string, TypeElement, SizeIcon, int, CardViewExplorerFileSource> factory = ViewModelSource.Factory((string fullPath, TypeElement type, SizeIcon sizeType, int size) =>
            new CardViewExplorerFileSource(fullPath, type, sizeType, size));
