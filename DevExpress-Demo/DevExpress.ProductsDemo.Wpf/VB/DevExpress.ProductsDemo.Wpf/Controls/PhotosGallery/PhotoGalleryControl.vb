...
Namespace ProductsDemo
    ...
    Public Class PhotoGalleryPanel
        ...
        Private Function GetProgress(ByVal elementNumber As Integer, ByVal elementCount As Integer) As Double
            If Gallery Is Nothing Then Return 1.0
            Dim [step] As Double = 1.0 / CDbl(elementCount + 1)
            Dim result As Double = 0.5 * (Gallery.AnimationProgress - CDbl(elementNumber) * [step]) / [step]
