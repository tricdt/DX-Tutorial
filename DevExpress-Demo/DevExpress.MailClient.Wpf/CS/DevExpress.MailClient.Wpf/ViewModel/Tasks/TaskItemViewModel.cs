...
namespace DevExpress.MailClient.ViewModel {
    ...
    public enum TaskCategory {
        [Image("pack://application:,,,/DevExpress.MailClient.Xpf;component/Images/Tasks/Category_HouseChores.svg")]
        HouseChores,
        [Image("pack://application:,,,/DevExpress.MailClient.Xpf;component/Images/Tasks/Category_Shopping.svg")]
        Shopping,
        [Image("pack://application:,,,/DevExpress.MailClient.Xpf;component/Images/Tasks/Category_Work.svg")]
        Work 
    }
    public enum FlagStatus { Today, Tomorrow, ThisWeek, NextWeek, NoDate, Custom, Completed }
    public enum TaskPriority {
        [Image("pack://application:,,,/DevExpress.MailClient.Xpf;component/Images/Tasks/Priority_Low.svg")]
        Low, 
        Medium,
        [Image("pack://application:,,,/DevExpress.MailClient.Xpf;component/Images/Tasks/Prioritized.svg")]
        High 
    }
