...
namespace DevExpress.MailClient.Helpers {
        ...
        internal static ImageSource UnknownUserPicture {
            get {
                if(unknownUserPicture == null) {
                    unknownUserPicture = new BitmapImage(FilePathHelper.GetAppImageUri("Contacts/Unknown-user", "png", UriKind.RelativeOrAbsolute));
    ...
    public class FilePathHelper {
        ...
        public static Uri GetAppImageUri(string path, string extension = "svg", UriKind uriKind = UriKind.Relative) {
            return new Uri(string.Format("/DevExpress.MailClient.Xpf;component/Images/{0}.{1}", path, extension), uriKind);
        }
